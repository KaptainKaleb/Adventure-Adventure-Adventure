...
def dialog00(user):
    ...
    time.sleep(3)
    print("You are " + user.name + " of the " + user.job + "s?")
    time.sleep(3)
    ...
    print("This tunnel will lead you to the sewer system.")
    time.sleep(1)

    print("There may be a few rats, but I'm sure you can deal with them, being the fine " + user.job + " you are.")
    time.sleep(2)

    print("Go on now, no time to lose!")
    time.sleep(1)

    print("*You enter the secret tunnel*")
    time.sleep(2)
